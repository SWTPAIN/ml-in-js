...
/******/ 	var hotCurrentHash = "cbf4663c0b6f10a6723e"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _node = __webpack_require__(59);
...
/***/ function(module, exports) {
	...
	Node.prototype.measureDistances = function (areaRangeObj, roomsRangeObj) {
	  ...
	  var areaRange = areaRangeObj.max;

	  for (var i in undefined.neighbors) {
	    var neighbor = undefined.neighbors[i];
	    var deltaRooms = (neighbor.rooms - undefined.rooms) / roomsRange;
	    var deltaArea = (neighbor.area - undefined.area) / areaRange;
	...
	Node.prototype.sortByDistance = function () {
	  undefined.neighbors.sort(function (a, b) {
